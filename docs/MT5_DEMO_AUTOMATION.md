...
from history. It checks that the fresh broker quote is within 0.10 price units
of the strategy entry; the DEMO-only transport repeats this check, rechecks
